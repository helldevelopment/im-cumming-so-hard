...
loadstring(game:HttpGet('https://raw.githubusercontent.com/helldevelopment/im-cumming-so-hard/refs/heads/main/library_oh_shit_im_still_cumming.lua'))()
getgenv().library.title = "Arsenal X | insanity.xyz"
getgenv().library.flags["Menu Accent Color"] = Color3.fromRGB(20,0,255)
-- [Legit Tab UI] ------------------------------------------------------------------------------------------------------------------------------------------------------------
...
SettingSection:AddColor({text = "Accent Color", flag = "Menu Accent Color", color = Color3.fromRGB(20,0,255), callback = function(color)
